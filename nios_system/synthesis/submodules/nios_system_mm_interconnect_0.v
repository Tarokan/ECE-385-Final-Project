...
module nios_system_mm_interconnect_0 (
		...
		output wire [3:0]  AVL_INT_0_AES_Slave_address,                      //                        AVL_INT_0_AES_Slave.address
		output wire        AVL_INT_0_AES_Slave_write,                        //                                           .write
		output wire        AVL_INT_0_AES_Slave_read,                         //                                           .read
		input  wire [15:0] AVL_INT_0_AES_Slave_readdata,                     //                                           .readdata
		output wire [15:0] AVL_INT_0_AES_Slave_writedata,                    //                                           .writedata
		output wire        AVL_INT_0_AES_Slave_chipselect,                   //                                           .chipselect
	...
	wire   [15:0] avl_int_0_aes_slave_agent_m0_readdata;                                              // AVL_INT_0_AES_Slave_translator:uav_readdata -> AVL_INT_0_AES_Slave_agent:m0_readdata
	wire          avl_int_0_aes_slave_agent_m0_waitrequest;                                           // AVL_INT_0_AES_Slave_translator:uav_waitrequest -> AVL_INT_0_AES_Slave_agent:m0_waitrequest
	wire          avl_int_0_aes_slave_agent_m0_debugaccess;                                           // AVL_INT_0_AES_Slave_agent:m0_debugaccess -> AVL_INT_0_AES_Slave_translator:uav_debugaccess
	wire   [28:0] avl_int_0_aes_slave_agent_m0_address;                                               // AVL_INT_0_AES_Slave_agent:m0_address -> AVL_INT_0_AES_Slave_translator:uav_address
	wire    [1:0] avl_int_0_aes_slave_agent_m0_byteenable;                                            // AVL_INT_0_AES_Slave_agent:m0_byteenable -> AVL_INT_0_AES_Slave_translator:uav_byteenable
	wire          avl_int_0_aes_slave_agent_m0_read;                                                  // AVL_INT_0_AES_Slave_agent:m0_read -> AVL_INT_0_AES_Slave_translator:uav_read
	wire          avl_int_0_aes_slave_agent_m0_readdatavalid;                                         // AVL_INT_0_AES_Slave_translator:uav_readdatavalid -> AVL_INT_0_AES_Slave_agent:m0_readdatavalid
	wire          avl_int_0_aes_slave_agent_m0_lock;                                                  // AVL_INT_0_AES_Slave_agent:m0_lock -> AVL_INT_0_AES_Slave_translator:uav_lock
	wire   [15:0] avl_int_0_aes_slave_agent_m0_writedata;                                             // AVL_INT_0_AES_Slave_agent:m0_writedata -> AVL_INT_0_AES_Slave_translator:uav_writedata
	wire          avl_int_0_aes_slave_agent_m0_write;                                                 // AVL_INT_0_AES_Slave_agent:m0_write -> AVL_INT_0_AES_Slave_translator:uav_write
	wire    [1:0] avl_int_0_aes_slave_agent_m0_burstcount;                                            // AVL_INT_0_AES_Slave_agent:m0_burstcount -> AVL_INT_0_AES_Slave_translator:uav_burstcount
	wire          avl_int_0_aes_slave_agent_rf_source_valid;                                          // AVL_INT_0_AES_Slave_agent:rf_source_valid -> AVL_INT_0_AES_Slave_agent_rsp_fifo:in_valid
	wire   [89:0] avl_int_0_aes_slave_agent_rf_source_data;                                           // AVL_INT_0_AES_Slave_agent:rf_source_data -> AVL_INT_0_AES_Slave_agent_rsp_fifo:in_data
	wire          avl_int_0_aes_slave_agent_rf_source_ready;                                          // AVL_INT_0_AES_Slave_agent_rsp_fifo:in_ready -> AVL_INT_0_AES_Slave_agent:rf_source_ready
	wire          avl_int_0_aes_slave_agent_rf_source_startofpacket;                                  // AVL_INT_0_AES_Slave_agent:rf_source_startofpacket -> AVL_INT_0_AES_Slave_agent_rsp_fifo:in_startofpacket
	wire          avl_int_0_aes_slave_agent_rf_source_endofpacket;                                    // AVL_INT_0_AES_Slave_agent:rf_source_endofpacket -> AVL_INT_0_AES_Slave_agent_rsp_fifo:in_endofpacket
	wire          avl_int_0_aes_slave_agent_rsp_fifo_out_valid;                                       // AVL_INT_0_AES_Slave_agent_rsp_fifo:out_valid -> AVL_INT_0_AES_Slave_agent:rf_sink_valid
	wire   [89:0] avl_int_0_aes_slave_agent_rsp_fifo_out_data;                                        // AVL_INT_0_AES_Slave_agent_rsp_fifo:out_data -> AVL_INT_0_AES_Slave_agent:rf_sink_data
	wire          avl_int_0_aes_slave_agent_rsp_fifo_out_ready;                                       // AVL_INT_0_AES_Slave_agent:rf_sink_ready -> AVL_INT_0_AES_Slave_agent_rsp_fifo:out_ready
	wire          avl_int_0_aes_slave_agent_rsp_fifo_out_startofpacket;                               // AVL_INT_0_AES_Slave_agent_rsp_fifo:out_startofpacket -> AVL_INT_0_AES_Slave_agent:rf_sink_startofpacket
	wire          avl_int_0_aes_slave_agent_rsp_fifo_out_endofpacket;                                 // AVL_INT_0_AES_Slave_agent_rsp_fifo:out_endofpacket -> AVL_INT_0_AES_Slave_agent:rf_sink_endofpacket
	...
	wire   [12:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> jtag_uart_0_avalon_jtag_slave_agent:cp_channel
	...
	wire   [12:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire   [12:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> sdram_s1_agent:cp_channel
	...
	wire          avl_int_0_aes_slave_agent_rp_valid;                                                 // AVL_INT_0_AES_Slave_agent:rp_valid -> router_002:sink_valid
	wire   [88:0] avl_int_0_aes_slave_agent_rp_data;                                                  // AVL_INT_0_AES_Slave_agent:rp_data -> router_002:sink_data
	wire          avl_int_0_aes_slave_agent_rp_ready;                                                 // router_002:sink_ready -> AVL_INT_0_AES_Slave_agent:rp_ready
	wire          avl_int_0_aes_slave_agent_rp_startofpacket;                                         // AVL_INT_0_AES_Slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          avl_int_0_aes_slave_agent_rp_endofpacket;                                           // AVL_INT_0_AES_Slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          avl_int_0_aes_slave_burst_adapter_source0_valid;                                    // AVL_INT_0_AES_Slave_burst_adapter:source0_valid -> AVL_INT_0_AES_Slave_agent:cp_valid
	wire   [88:0] avl_int_0_aes_slave_burst_adapter_source0_data;                                     // AVL_INT_0_AES_Slave_burst_adapter:source0_data -> AVL_INT_0_AES_Slave_agent:cp_data
	wire          avl_int_0_aes_slave_burst_adapter_source0_ready;                                    // AVL_INT_0_AES_Slave_agent:cp_ready -> AVL_INT_0_AES_Slave_burst_adapter:source0_ready
	wire   [12:0] avl_int_0_aes_slave_burst_adapter_source0_channel;                                  // AVL_INT_0_AES_Slave_burst_adapter:source0_channel -> AVL_INT_0_AES_Slave_agent:cp_channel
	wire          avl_int_0_aes_slave_burst_adapter_source0_startofpacket;                            // AVL_INT_0_AES_Slave_burst_adapter:source0_startofpacket -> AVL_INT_0_AES_Slave_agent:cp_startofpacket
	wire          avl_int_0_aes_slave_burst_adapter_source0_endofpacket;                              // AVL_INT_0_AES_Slave_burst_adapter:source0_endofpacket -> AVL_INT_0_AES_Slave_agent:cp_endofpacket
	...
	wire          router_002_src_valid;                                                               // router_002:src_valid -> AVL_INT_0_AES_Slave_rsp_width_adapter:in_valid
	wire   [88:0] router_002_src_data;                                                                // router_002:src_data -> AVL_INT_0_AES_Slave_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                                               // AVL_INT_0_AES_Slave_rsp_width_adapter:in_ready -> router_002:src_ready
	wire   [12:0] router_002_src_channel;                                                             // router_002:src_channel -> AVL_INT_0_AES_Slave_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                                       // router_002:src_startofpacket -> AVL_INT_0_AES_Slave_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                                         // router_002:src_endofpacket -> AVL_INT_0_AES_Slave_rsp_width_adapter:in_endofpacket
	wire          avl_int_0_aes_slave_rsp_width_adapter_src_valid;                                    // AVL_INT_0_AES_Slave_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [106:0] avl_int_0_aes_slave_rsp_width_adapter_src_data;                                     // AVL_INT_0_AES_Slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          avl_int_0_aes_slave_rsp_width_adapter_src_ready;                                    // rsp_demux:sink_ready -> AVL_INT_0_AES_Slave_rsp_width_adapter:out_ready
	wire   [12:0] avl_int_0_aes_slave_rsp_width_adapter_src_channel;                                  // AVL_INT_0_AES_Slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          avl_int_0_aes_slave_rsp_width_adapter_src_startofpacket;                            // AVL_INT_0_AES_Slave_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          avl_int_0_aes_slave_rsp_width_adapter_src_endofpacket;                              // AVL_INT_0_AES_Slave_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                                                  // cmd_mux:src_valid -> AVL_INT_0_AES_Slave_cmd_width_adapter:in_valid
	wire  [106:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> AVL_INT_0_AES_Slave_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                  // AVL_INT_0_AES_Slave_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire   [12:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> AVL_INT_0_AES_Slave_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                                          // cmd_mux:src_startofpacket -> AVL_INT_0_AES_Slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                                            // cmd_mux:src_endofpacket -> AVL_INT_0_AES_Slave_cmd_width_adapter:in_endofpacket
	wire          avl_int_0_aes_slave_cmd_width_adapter_src_valid;                                    // AVL_INT_0_AES_Slave_cmd_width_adapter:out_valid -> AVL_INT_0_AES_Slave_burst_adapter:sink0_valid
	wire   [88:0] avl_int_0_aes_slave_cmd_width_adapter_src_data;                                     // AVL_INT_0_AES_Slave_cmd_width_adapter:out_data -> AVL_INT_0_AES_Slave_burst_adapter:sink0_data
	wire          avl_int_0_aes_slave_cmd_width_adapter_src_ready;                                    // AVL_INT_0_AES_Slave_burst_adapter:sink0_ready -> AVL_INT_0_AES_Slave_cmd_width_adapter:out_ready
	wire   [12:0] avl_int_0_aes_slave_cmd_width_adapter_src_channel;                                  // AVL_INT_0_AES_Slave_cmd_width_adapter:out_channel -> AVL_INT_0_AES_Slave_burst_adapter:sink0_channel
	wire          avl_int_0_aes_slave_cmd_width_adapter_src_startofpacket;                            // AVL_INT_0_AES_Slave_cmd_width_adapter:out_startofpacket -> AVL_INT_0_AES_Slave_burst_adapter:sink0_startofpacket
	wire          avl_int_0_aes_slave_cmd_width_adapter_src_endofpacket;                              // AVL_INT_0_AES_Slave_cmd_width_adapter:out_endofpacket -> AVL_INT_0_AES_Slave_burst_adapter:sink0_endofpacket
	...
	wire          avl_int_0_aes_slave_agent_rdata_fifo_src_valid;                                     // AVL_INT_0_AES_Slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [17:0] avl_int_0_aes_slave_agent_rdata_fifo_src_data;                                      // AVL_INT_0_AES_Slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          avl_int_0_aes_slave_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter:in_0_ready -> AVL_INT_0_AES_Slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                                      // avalon_st_adapter:out_0_valid -> AVL_INT_0_AES_Slave_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_out_0_data;                                                       // avalon_st_adapter:out_0_data -> AVL_INT_0_AES_Slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                      // AVL_INT_0_AES_Slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                      // avalon_st_adapter:out_0_error -> AVL_INT_0_AES_Slave_agent:rdata_fifo_sink_error
	...
	) avl_int_0_aes_slave_translator (
		.clk                    (clk_0_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (avl_int_0_aes_slave_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (avl_int_0_aes_slave_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (avl_int_0_aes_slave_agent_m0_read),                //                         .read
		.uav_write              (avl_int_0_aes_slave_agent_m0_write),               //                         .write
		.uav_waitrequest        (avl_int_0_aes_slave_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (avl_int_0_aes_slave_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (avl_int_0_aes_slave_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (avl_int_0_aes_slave_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (avl_int_0_aes_slave_agent_m0_writedata),           //                         .writedata
		.uav_lock               (avl_int_0_aes_slave_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (avl_int_0_aes_slave_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (AVL_INT_0_AES_Slave_address),                      //      avalon_anti_slave_0.address
		.av_write               (AVL_INT_0_AES_Slave_write),                        //                         .write
		.av_read                (AVL_INT_0_AES_Slave_read),                         //                         .read
		.av_readdata            (AVL_INT_0_AES_Slave_readdata),                     //                         .readdata
		.av_writedata           (AVL_INT_0_AES_Slave_writedata),                    //                         .writedata
		.av_chipselect          (AVL_INT_0_AES_Slave_chipselect),                   //                         .chipselect
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) avl_int_0_aes_slave_agent (
		.clk                     (clk_0_clk_clk),                                           //             clk.clk
		.reset                   (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (avl_int_0_aes_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (avl_int_0_aes_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (avl_int_0_aes_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (avl_int_0_aes_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (avl_int_0_aes_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (avl_int_0_aes_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (avl_int_0_aes_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (avl_int_0_aes_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (avl_int_0_aes_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (avl_int_0_aes_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (avl_int_0_aes_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (avl_int_0_aes_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (avl_int_0_aes_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (avl_int_0_aes_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (avl_int_0_aes_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (avl_int_0_aes_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (avl_int_0_aes_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (avl_int_0_aes_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (avl_int_0_aes_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (avl_int_0_aes_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (avl_int_0_aes_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (avl_int_0_aes_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (avl_int_0_aes_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (avl_int_0_aes_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (avl_int_0_aes_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (avl_int_0_aes_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (avl_int_0_aes_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (avl_int_0_aes_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (avl_int_0_aes_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (avl_int_0_aes_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (avl_int_0_aes_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (avl_int_0_aes_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                           //                .error
		.rdata_fifo_src_ready    (avl_int_0_aes_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (avl_int_0_aes_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (avl_int_0_aes_slave_agent_rdata_fifo_src_data),           //                .data
	...
	) avl_int_0_aes_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                        //       clk.clk
		.reset             (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (avl_int_0_aes_slave_agent_rf_source_data),             //        in.data
		.in_valid          (avl_int_0_aes_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (avl_int_0_aes_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (avl_int_0_aes_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (avl_int_0_aes_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (avl_int_0_aes_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (avl_int_0_aes_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (avl_int_0_aes_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (avl_int_0_aes_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (avl_int_0_aes_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	nios_system_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (avl_int_0_aes_slave_agent_rp_ready),               //      sink.ready
		.sink_valid         (avl_int_0_aes_slave_agent_rp_valid),               //          .valid
		.sink_data          (avl_int_0_aes_slave_agent_rp_data),                //          .data
		.sink_startofpacket (avl_int_0_aes_slave_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (avl_int_0_aes_slave_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	) avl_int_0_aes_slave_burst_adapter (
		.clk                   (clk_0_clk_clk),                                           //       cr0.clk
		.reset                 (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),        // cr0_reset.reset
		.sink0_valid           (avl_int_0_aes_slave_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (avl_int_0_aes_slave_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (avl_int_0_aes_slave_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (avl_int_0_aes_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (avl_int_0_aes_slave_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (avl_int_0_aes_slave_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (avl_int_0_aes_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (avl_int_0_aes_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (avl_int_0_aes_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (avl_int_0_aes_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (avl_int_0_aes_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (avl_int_0_aes_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	nios_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),        // clk_reset.reset
		.sink_ready         (avl_int_0_aes_slave_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (avl_int_0_aes_slave_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (avl_int_0_aes_slave_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (avl_int_0_aes_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (avl_int_0_aes_slave_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (avl_int_0_aes_slave_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) avl_int_0_aes_slave_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                           //       clk.clk
		.reset                (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),        // clk_reset.reset
		...
		.out_endofpacket      (avl_int_0_aes_slave_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (avl_int_0_aes_slave_rsp_width_adapter_src_data),          //          .data
		.out_channel          (avl_int_0_aes_slave_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (avl_int_0_aes_slave_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (avl_int_0_aes_slave_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (avl_int_0_aes_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) avl_int_0_aes_slave_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                           //       clk.clk
		.reset                (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),        // clk_reset.reset
		...
		.out_endofpacket      (avl_int_0_aes_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (avl_int_0_aes_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (avl_int_0_aes_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (avl_int_0_aes_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (avl_int_0_aes_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (avl_int_0_aes_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                   // (terminated)
	);
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (avl_int_0_aes_slave_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (avl_int_0_aes_slave_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (avl_int_0_aes_slave_agent_rdata_fifo_src_ready),   //         .ready
